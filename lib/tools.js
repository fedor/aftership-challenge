...
(function() {
  ...
  exports.request_xml = function() {
    var callback, request_args, _i;
    request_args = 2 <= arguments.length ? __slice.call(arguments, 0, _i = arguments.length - 1) : (_i = 0, []), callback = arguments[_i++];
    return get.apply(this, request_args.concat(function(error, body) {
      if (error) {
        return callback(error);
      }
  ...
  exports.request_form_submit = function() {
    var callback, request_args, _i;
    request_args = 2 <= arguments.length ? __slice.call(arguments, 0, _i = arguments.length - 1) : (_i = 0, []), callback = arguments[_i++];
    return request.post.apply(this, request_args.concat(function(error, response, body) {
      if (error) {
        return callback(error);
      }
      if (response.statusCode !== 200) {
